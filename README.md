...
flowchart TD
    ...
    classDef interfaces fill:#f9f,stroke:#333,stroke-width:2px
...
flowchart LR
    ...
    classDef subProcess fill:#dfd,stroke:#333,stroke-width:1px
...
flowchart TD
    ...
    classDef data fill:#bbf,stroke:#333,stroke-width:1px
    classDef feedback fill:#fbb,stroke:#333,stroke-width:1px
